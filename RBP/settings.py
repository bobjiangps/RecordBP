"""
Django settings for RBP project.
...
DATABASES = {
    'default': {
        ...
        'NAME': base64.b64decode(STORED['db_name']).decode(),
        'USER': base64.b64decode(STORED['db_user']).decode(),
        'PASSWORD': base64.b64decode(STORED['db_pw']).decode(),
        'HOST': '127.0.0.1',
        'PORT': 3306,
        'OPTIONS': {
            'autocommit': True,
